            ...
            item {
                SettingsGroup {
                    SettingsSwitchRow(
                        ...
                        "Retain decoder precision through Aurora effects, then send float32 to Android. Tracks needing gapless trimming, silence skipping or other formats use compatibility output. See Signal Path. Restart Aurora to apply.",
                        prefs.preferHighRes,
