...
$dump = & $adb -s 0016615BM001167 shell uiautomator dump /sdcard/aurora-r2a-ui.xml 2>&1
if ($dump -notmatch 'UI hierchary dumped') { throw "UI did not become ready: $dump" }
& $adb -s 0016615BM001167 pull /sdcard/aurora-r2a-ui.xml (Join-Path $PSScriptRoot "$Name.xml")
& $adb -s 0016615BM001167 shell screencap -p /sdcard/aurora-r2a.png
& $adb -s 0016615BM001167 pull /sdcard/aurora-r2a.png (Join-Path $PSScriptRoot "$Name.png")
