...
& $adb -s $Serial pull /sdcard/aurora-r0-ui.xml "_artifacts/r0/$Name.xml"
& $adb -s $Serial shell screencap -p /sdcard/aurora-r0.png
& $adb -s $Serial pull /sdcard/aurora-r0.png "_artifacts/r0/$Name.png"
[xml]$tree=Get-Content "_artifacts/r0/$Name.xml"
